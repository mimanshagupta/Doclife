            ...
            public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
                ...
                if (child != null && mGestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (recyclerView.getChildPosition(child) == 4) {
                        Intent i = new Intent(LabReportCentre.this, OTSchedule.class);
                        startActivity(i);
                    }
                    if (recyclerView.getChildPosition(child) == 5) {
                        Intent i = new Intent(LabReportCentre.this,DutySchedule.class);
                        startActivity(i);
                    }
                    if (recyclerView.getChildPosition(child) == 6) {
                        Intent i = new Intent(LabReportCentre.this,EmergencyCenter.class);
                        startActivity(i);
                    }
                    return true;
                }
